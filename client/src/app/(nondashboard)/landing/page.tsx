...
const Landing = () => {
  ...
  const handleCoureseClick = (courseId: string) => {
    ...
    >
      ...
      >
        ...
        <p className="landing__featured-description">
          ...
          courses just for you and preparing yout entire journey for learning
          and making the most.
        </p>
      ...
      >
        ...
        <CourseCardSearch course={course} onClick={() => handleCoureseClick(course.courseId)} />
